...
const DETAILED: Record<string, ProfileSeed> = {
  ...
  Encinitas: {
    ...
    nearby: ['Cardiff', 'Solana Beach', 'Carlsbad'],
  },
  Cardiff: {
    shortDescription: 'Find Cardiff happy hours along Coast Highway 101 with beach bars and seafood spots.',
    overview: [
      'Cardiff-by-the-Sea is part of Encinitas but reads as its own stretch of coast, with happy hours clustered along South Coast Highway 101 and San Elijo Avenue.',
      'Most venues sit within walking distance of the beach, so sunset hours fill up first on warm days.',
    ],
    planningTip: 'Parking along Coast Highway 101 is metered and tight near sunset; the San Elijo side streets are usually easier.',
    nearby: ['Encinitas', 'Solana Beach', 'Del Mar'],
  },
  'Del Mar': {
...
const NEARBY: Record<string, string[]> = {
  ...
  Tierrasanta: ['Kearny Mesa', 'Mission Valley', 'Scripps Ranch'],
  'Bankers Hill': ['Hillcrest', 'Little Italy', 'Balboa Park'],
  'Cortez Hill': ['East Village', 'Bankers Hill', 'Little Italy'],
  'Santa Ysabel': ['Ramona', 'Escondido', 'Valley Center'],
  'Logan Heights': ['East Village', 'National City', 'Balboa Park'],
  'National City': ['Chula Vista', 'Logan Heights', 'Coronado'],
  ...
  Cardiff: ['Encinitas', 'Solana Beach', 'Del Mar'],
  'Imperial Beach': ['Chula Vista', 'Coronado', 'Otay Mesa'],
  'Otay Mesa': ['San Ysidro', 'Chula Vista', 'Imperial Beach'],
  'San Ysidro': ['Otay Mesa', 'Chula Vista', 'Imperial Beach'],
  Encanto: ['City Heights', 'Paradise Hills', 'Lemon Grove'],
  'Paradise Hills': ['Encanto', 'National City', 'Chula Vista'],
